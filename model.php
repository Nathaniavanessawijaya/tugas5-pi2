...
{
	 $sql = "UPDATE kontrak_mk SET matakuliah_id='$matakuliah_id', mhs_id='$mhs_id' WHERE id='$id'";
	 $this->conn->query($sql);
}
...
// tabel matakuliah
public function insert_matakuliah($id, $nama_mk)
{
...
public function update_matakuliah($id, $nama_mk)
{
